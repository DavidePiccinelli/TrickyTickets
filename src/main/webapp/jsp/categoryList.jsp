...
<body>
	...
	<!-- Area per la ricerca nelle categorie con pulsante Reset -->
		...
		<div class="card">
			<h5 class="card-header"	style="background-color: #00061df7; color: white;">Elenco categorie</h5>
			<div class="card-body">
				<div class="row g-3">
					<div class="col">
						<input type="text" placeholder="Ricerca per nome..." name="name" class="form-control" value="<%=ServletUtility.getParameter("name", request)%>">
					</div>

					<div class="col">
						<input type="submit" class="btn  btn-outline-primary"name="operation" value="Cerca"></input>
						 oppure 
						 <input type="submit" class="btn  btn-outline-secondary" name="operation" value="Ripristina">
					</div>
				</div>
